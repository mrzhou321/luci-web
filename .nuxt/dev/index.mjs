...
import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, setResponseHeaders, createError, getRouterParam, readBody, getQuery as getQuery$1, getResponseStatusText } from 'file://D:/Works/nuxt3-luci-env/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/Works/nuxt3-luci-env/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/Works/nuxt3-luci-env/node_modules/devalue/index.js';
import destr from 'file://D:/Works/nuxt3-luci-env/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://D:/Works/nuxt3-luci-env/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://D:/Works/nuxt3-luci-env/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://D:/Works/nuxt3-luci-env/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://D:/Works/nuxt3-luci-env/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/Works/nuxt3-luci-env/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://D:/Works/nuxt3-luci-env/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://D:/Works/nuxt3-luci-env/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/Works/nuxt3-luci-env/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/Works/nuxt3-luci-env/node_modules/unenv/runtime/fetch/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://D:/Works/nuxt3-luci-env/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://D:/Works/nuxt3-luci-env/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/Works/nuxt3-luci-env/node_modules/errx/dist/index.js';
import { isVNode, unref, version } from 'file://D:/Works/nuxt3-luci-env/node_modules/vue/index.mjs';
import { hash } from 'file://D:/Works/nuxt3-luci-env/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/Works/nuxt3-luci-env/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/Works/nuxt3-luci-env/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/Works/nuxt3-luci-env/node_modules/radix3/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/Works/nuxt3-luci-env/node_modules/@unhead/shared/dist/index.mjs';
...
const _OpuwRpaq0E = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "D:/Works/nuxt3-luci-env";
...
const _lazy_dCZ1lJ = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_dCZ1lJ, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_dCZ1lJ, lazy: true, middleware: false, method: undefined }
];

const serverAssets = [{"baseName":"server","dir":"D:/Works/nuxt3-luci-env/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/Works/nuxt3-luci-env"}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/Works/nuxt3-luci-env/server"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/Works/nuxt3-luci-env/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/Works/nuxt3-luci-env/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:/Works/nuxt3-luci-env/.data/kv"}));
...
const getClientManifest = () => import('file://D:/Works/nuxt3-luci-env/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/Works/nuxt3-luci-env/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
